...
public class DibujoEsperarMesa extends JPanel {
    ...
    public DibujoEsperarMesa() {
        max = rows * cols;
        setLayout(new GridBagLayout());
        gbc = new GridBagConstraints();
        addInitialRows();
        EsperandoMesaDibujoController.setDibujo(this);
        EsperandoMesaDibujoController.paint(this);
    }
