...
public class DibujoZonaDeJuegos extends JPanel {
    ...
    public DibujoZonaDeJuegos() {
        max = rows * cols;
        setLayout(new GridBagLayout());
        gbc = new GridBagConstraints();
        addInitialRows();
        ZonaDeJuegosDibujoController.setDibujo(this);
        ZonaDeJuegosDibujoController.paint(this);
    }
