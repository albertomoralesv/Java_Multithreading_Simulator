...
public class DibujoFilaParaEntrar extends JPanel {
    ...
    public DibujoFilaParaEntrar() {
        max = rows * cols;
        setLayout(new GridBagLayout());
        gbc = new GridBagConstraints();
        addInitialRows();
        FilaParaEntrarDibujoController.setDibujo(this);
        FilaParaEntrarDibujoController.paint(this);
    }
    ...
    private void shiftComponentsRight() {
